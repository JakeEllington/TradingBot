...
class Process:
    def __init__(self):
        ...
        self.symbol_full = 'BCHUSDTM'
        self.symbol = 'BCH'
        self.symbol_spot_signal = 'bch_binance_spot'
        self.symbol_perp_signal = 'bch_binance_perp'
    ...
    def update_settings(self):
        ...
        trade_setting = trade_settings_col.find_one(myquery, sort=[('_id', pymongo.DESCENDING)])
    ...
    while True:
        ...
        if proc.symbol_full in proc.watch_stock:
            ...
            if x_signal.reason == "OK":
                ...
                print("Checking for signals BCH")
                # print("Result: ", result)
